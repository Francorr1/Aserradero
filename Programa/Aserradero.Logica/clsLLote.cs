...
namespace Aserradero.Logica
{
    public class clsLLote
    {
        ...
        public List<clsELote> informeRegistroPorFecha(string fecha)
        {
            List<clsELote> coleccionLotes = new List<clsELote>(); // Declaro una lista de objetos de tipo entidad Lote
            coleccionLotes = datosLote.listarLotesPorFecha(fecha); // Se ejecuta la función y se guarda en la lista la información recibida
