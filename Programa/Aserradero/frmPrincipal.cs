...
namespace Aserradero
{
    public partial class frmPrincipal : Form
    {
        ...
        public clsLUsuario logicaUsuario = new clsLUsuario();
        ...
        public clsEPedido.clsEPedidoSimple entidadPedidoSimple = new clsEPedido.clsEPedidoSimple();
        ...
        public clsELote.clsELoteSimple entidadLoteSimple = new clsELote.clsELoteSimple();
        public clsEGrupoTroza.clsEGrupoTrozaSimple entidadGrupoTrozaSimple = new clsEGrupoTroza.clsEGrupoTrozaSimple();

        public clsECliente[] coleccionClientes;
        public clsEUsuario[] coleccionUsuarios;
        ...
        List<clsEUsuario> listaUsuarios = new List<clsEUsuario>();
        ...
        private void esconderObjetosAgregar()
        {
            ...
            mtbA2.Hide();
            mtbA2.Text = "";
            nudCantidadTrozasLote.Hide();
            nudCantidadTrozasLote.Value = 0;
            nudCantidadTrozasLote.Maximum = 100000;
        ...
        object[] conseguirDatos()
        {
            ...
            if (logicaPedido.listarPedidos() == null)
            {
                herramientasInterfaz.errorConexion();
                lblTitulo.Text = "Presione el botón actualizar para volver a intentar la conexión";
                return null;
            }
            ...
            switch (lblTitulo.Text) // TODO: Buscar una mejor comprobación
            {
                case "Pedidos":
                    ...
                    cboFiltroPedidos.Items.Clear();
                    cboFiltroPedidos.Text = "Todos";

                    pnlAgregarTrozas.Hide();
                    cboDiametroGrupoTroza.Hide();
                    cboRodalGrupoTroza.Hide();
                    nudCantidadTrozasLote.Hide();
                    cboProductosLote.Hide();
                    cboUsuariosLote.Hide();
                    calFechaLote.Hide();
                    btnFechaLote.Hide();

                    cboFiltroPedidos.Show();

                    cboFiltroPedidos.Items.Add("Todos");
                    cboFiltroPedidos.Items.Add("Completados");
                    cboFiltroPedidos.Items.Add("Pendientes");
                ...
                case "Trozas":
                    ...
                    cboDiametroGrupoTroza.Items.Clear();
                    cboRodalGrupoTroza.Items.Clear();
                    cboDiametroGrupoTroza.Text = "Diámetro";
                    cboRodalGrupoTroza.Text = "Rodal";

                    cboDiametroGrupoTroza.Show();
                    cboRodalGrupoTroza.Show();
                    pnlEntregar.Hide();
                    nudCantidadTrozasLote.Hide();
                    cboProductosLote.Hide();
                    cboUsuariosLote.Hide();
                    ...
                    for (int cont = 0; cont < coleccionEspeciesSimples.Length; cont++) //Rellena el combobox con los nombres de las especies
                    {
                        cboA3.Items.Insert(cont, coleccionEspeciesSimples[cont].nombre);
                    }

                    for(int cont = 0; cont < coleccionRodales.Length; cont++) //Rellena el combobox con todas las especies de los rodales
                    {
                        cboRodalGrupoTroza.Items.Insert(cont, coleccionRodales[cont].entidadEspecie.nombre);
                    }

                    for(int cont = 0; cont < coleccionGruposTrozas.Length; cont++)
                    {
                        if (!cboDiametroGrupoTroza.Items.Contains(coleccionGruposTrozas[cont].diametro))
                        {
                            cboDiametroGrupoTroza.Items.Add(coleccionGruposTrozas[cont].diametro);
                        }
                    }
                ...
                case "Lotes":
                    ...
                    lblAT2.Show();
                    nudCantidadTrozasLote.Show();
                    lblAT3.Text = "Producto";
                    lblAT3.Show();
                    nudCantidadTrozasLote.Show();

                    cboProductosLote.Text = "Productos";
                    cboUsuariosLote.Text = "Usuarios";
                    ...
                    calFechaLote.Hide();
                    btnFechaLote.Show();
                    cboProductosLote.Show();
                    cboUsuariosLote.Show();

                    cboFiltroPedidos.Hide();

                    listaUsuarios.Clear();
                    cboProductosLote.Items.Clear(); //Se vacían los datos anteriormente almacenados en el comboBox
                    cboUsuariosLote.Items.Clear(); //Se vacían los datos anteriormente almacenados en el comboBox

                    coleccionProductos = logicaProducto.listarProductos().ToArray();
                    for (int cont = 0; cont < coleccionProductos.Length; cont++)
                    {
                        cboProductosLote.Items.Insert(cont, coleccionProductos[cont].tipo); //Se carga al comboBox productos con todos los nombres de los productos en el sistema
                    }
                    cboProductosLote.Show();

                    subContador = 0;
                    coleccionUsuarios = logicaUsuario.listarUsuarios().ToArray();
                    for (int cont = 0; cont < coleccionUsuarios.Length; cont++)
                    {
                        if (coleccionUsuarios[cont].entidadTipoUsuario.idTipo == 1 || coleccionUsuarios[cont].entidadTipoUsuario.idTipo == 2)
                        {
                            cboUsuariosLote.Items.Insert(subContador, coleccionUsuarios[cont].nombre); //Se carga al comboBox productos con todos los nombres de los productos en el sistema
                            subContador++;
                            listaUsuarios.Add(coleccionUsuarios[cont]);
                        }
                    }
                    coleccionUsuarios = listaUsuarios.ToArray();
        ...
        private void btnAceptarAgregar_Click(object sender, EventArgs e)
        {
            switch (lblTitulo.Text)
            {
                ...
                case "Lotes":
                    ...
                    if ((txtA1.Text == "")|| (cboA3.Text == "") || (cboA4.Text == ""))
                    {
                        lblErrorAgregar.Show();
                    }
                    ...
                    else
                    {
                        ...
                        lote.cantidadTroza = Convert.ToInt32(nudCantidadTrozasLote.Value);
                        ...
                        entidadRegistro = new clsERegistro();
                        nudCantidadTrozasLote.Value = 0;
                        nudCantidadTrozasLote.Maximum = 1000000;
                    }
        ...
        private void btnEntregar_Click(object sender, EventArgs e)
        {
            ...
            }else
            {
                ...
                { 
                    ...
                    limite = pedidoSeleccionado.cantidadSolicitada[0] - pedidoSeleccionado.cantidadEntregada[0];

                    if (limite < pedidoSeleccionado.coleccionProductos[0].stock)
                    {
                        nudEntregar1.Maximum = limite;
                    }else
                    {
                        nudEntregar1.Maximum = pedidoSeleccionado.coleccionProductos[0].stock;
                    }
                    ...
                    if (pedidoSeleccionado.coleccionProductos.Length > 1)
                    {
                        ...
                        limite = pedidoSeleccionado.cantidadSolicitada[1] - pedidoSeleccionado.cantidadEntregada[1];

                        if (limite < pedidoSeleccionado.coleccionProductos[1].stock)
                        {
                            nudEntregar2.Maximum = limite;
                        }
                        else
                        {
                            nudEntregar2.Maximum = pedidoSeleccionado.coleccionProductos[1].stock;
                        }
                    }
                    ...
                    if (pedidoSeleccionado.coleccionProductos.Length > 2)
                    {
                        ...
                        limite = pedidoSeleccionado.cantidadSolicitada[2] - pedidoSeleccionado.cantidadEntregada[2];

                        if (limite < pedidoSeleccionado.coleccionProductos[2].stock)
                        {
                            nudEntregar3.Maximum = limite;
                        }
                        else
                        {
                            nudEntregar3.Maximum = pedidoSeleccionado.coleccionProductos[2].stock;
                        }
                    }
                    ...
                    if (pedidoSeleccionado.coleccionProductos.Length > 3)
                    {
                        ...
                        limite = pedidoSeleccionado.cantidadSolicitada[3] - pedidoSeleccionado.cantidadEntregada[3];

                        if (limite < pedidoSeleccionado.coleccionProductos[3].stock)
                        {
                            nudEntregar4.Maximum = limite;
                        }
                        else
                        {
                            nudEntregar4.Maximum = pedidoSeleccionado.coleccionProductos[3].stock;
                        }
                    }
                }
            }
        ...
        private void cboFiltroPedidos_SelectedIndexChanged(object sender, EventArgs e)
        {
            switch (cboFiltroPedidos.SelectedIndex)
            {
                case 0:
                    actualizarDgvPrincipal();
                    break;
                case 1:
                    clsEPedido[] coleccionPedidosCompletados = logicaPedido.listarPedidosPorCompletado(true).ToArray();
                    dgvPrincipal.DataSource = entidadPedidoSimple.desarmarPedido(coleccionPedidosCompletados);
                    break;
                case 2:
                    clsEPedido[] coleccionPedidosPendientes = logicaPedido.listarPedidosPorCompletado(false).ToArray();
                    dgvPrincipal.DataSource = entidadPedidoSimple.desarmarPedido(coleccionPedidosPendientes);
                    break;
            }
        }
        ...
        #endregion
        #region Barra Filtrado Lotes

        private void btnFechaLote_Click(object sender, EventArgs e)
        {
            if (calFechaLote.Visible)
            {
                calFechaLote.Hide();
            }else
            {
        ...
        private void calFechaLote_DateSelected(object sender, DateRangeEventArgs e)
        {
            calFechaLote.Hide();

            DateTime fechaSeleccionada = new DateTime();
            fechaSeleccionada = calFechaLote.SelectionStart;
            string fechaConsulta = fechaSeleccionada.ToString("yyyy-MM-dd");

            coleccionLotes = logicaLote.informeRegistroPorFecha(fechaConsulta).ToArray();
            dgvPrincipal.DataSource = entidadLoteSimple.desarmarLote(coleccionLotes);
        }

        private void cboUsuariosLote_SelectedIndexChanged(object sender, EventArgs e)
        {
            coleccionLotes = logicaLote.informeRegistroPorUsuario(coleccionUsuarios[cboUsuariosLote.SelectedIndex].ci).ToArray();
            dgvPrincipal.DataSource = entidadLoteSimple.desarmarLote(coleccionLotes);
        }

        private void cboProductosLote_SelectedIndexChanged(object sender, EventArgs e)
        {
            coleccionLotes = logicaLote.informeRegistroPorProducto(coleccionProductos[cboProductosLote.SelectedIndex].id).ToArray();
            dgvPrincipal.DataSource = entidadLoteSimple.desarmarLote(coleccionLotes);
        }
        #endregion
        #region Barra Filtrado GrupoTrozas

        private void cboRodalGrupoTroza_SelectedIndexChanged(object sender, EventArgs e)
        {
            int idRodal;
            idRodal = coleccionRodales[cboRodalGrupoTroza.SelectedIndex].id;
            coleccionGrupoTrozas = logicaGrupoTroza.informeGrupoTrozaPorRodal(idRodal).ToArray();
            dgvPrincipal.DataSource = entidadGrupoTrozaSimple.desarmarGrupoTroza(coleccionGrupoTrozas);
        }

        private void cboDiametroGrupoTroza_SelectedIndexChanged(object sender, EventArgs e)
        {
            int diametro;
            diametro = Convert.ToInt32(cboDiametroGrupoTroza.SelectedItem);
            coleccionGrupoTrozas = logicaGrupoTroza.informeGrupoTrozaPorDiametro(diametro).ToArray();
            dgvPrincipal.DataSource = entidadGrupoTrozaSimple.desarmarGrupoTroza(coleccionGrupoTrozas);
        }
        #endregion
        ...
        {
            nudCantidadTrozasLote.Maximum = coleccionGrupoTrozas[cboA4.SelectedIndex].cantidad;
        }
